...
def main():
    # Directorios a evaluar (Relativos a la raíz del proyecto)
    base_path = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    directories = [
        os.path.join(base_path, "src"),            # Frontend React + TypeScript
        os.path.join(base_path, "java-engine/src") # Backend Java
    ]
    ...
    frontend_dir = os.path.join(base_path, "src")
    ...
    report_path = os.path.join(base_path, "docs/reports/complexity_report.txt")
